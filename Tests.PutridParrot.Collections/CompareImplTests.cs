...
namespace Tests.PutridParrot.Collections
{
    ...
    public class ComparerTests
    {
        ...
        public void Constructor_NullComparerFunc_ExpectException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new Comparer<string>(compFunc));
        }
        ...
        public void Constructor_NullHasFunc_ExpectException()
        {
            ...
            Assert.Throws<ArgumentNullException>(() => new Comparer<string>(
        ...
        {
            var comparer = new Comparer<string>((a, b) => 123);
        ...
        public void GetHashCode_UseDefault()
        {
            ...
            var comparer = new Comparer<string>(String.CompareOrdinal);
